	...
	if has("gui_running")
		...
		if has("gui_macvim")
			try
				...
				set guifont=Terminess\ Powerline:h11
				set noantialias
			catch
...
" Formatting {
	...
	au FileType eco setlocal tabstop=2 expandtab shiftwidth=2 softtabstop=2 nobomb

	au BufRead,BufNewFile *.js	set ft=javascript

	au BufRead,BufNewFile *.rs	set nosmartindent
